...
#define STRING_CONFIG_H_AUTHOR "ZJC" // Who made the changes.
...
// Define this to set a custom name for your generic Mendel,
 #define CUSTOM_MENDEL_NAME "ZJC Mendel"
...
#define EXTRUDER_WATTS (12.0*12.0/3.3) //  P=I^2/R
#define BED_WATTS (12.0*12.0/1.5)      // P=I^2/R
